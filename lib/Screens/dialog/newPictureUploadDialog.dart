                    ...
                    children: <Widget>[
                      ...
                      ButtonBar(
                        ...
                        children: <Widget>[
                          ElevatedButton(
                            onPressed: () async {
                              await onAlbumPickProfilePicture(
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              await onCameraPickProfilePicture(
                                imagePicker: _imagePicker,
                                context: context,
                              );
                            },
...
Future newItemPictureDialog({@required BuildContext context,
                             @required User user,
              ...
              child: SizedBox.expand(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "Where would you like me to get the new item picture from?",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Colors.grey[700],
                          fontFamily: 'Proxima Nova',
